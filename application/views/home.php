  ...
  <head>
    ...
    <body>
   <?php include('layouts/front_header.php'); ?>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="single-offer">
                <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/o1.png" alt="">
            ...
            <div class="col-lg-4">
              <div class="single-offer">
                <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/o2.png" alt="">
            ...
            <div class="col-lg-4">
              <div class="single-offer">
                <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/o3.png" alt="">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6">
              <div class="single-course">
                <div class="thumb">
                  <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/c1.jpg" alt="">
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="single-course">
                <div class="thumb">
                  <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/c2.jpg" alt="">
                </div>
                <span class="course-status">Course Available</span>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="single-course">
                <div class="thumb">
                  <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/c3.jpg" alt="">
                </div>
                <span class="course-status">Course Available</span>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="single-course">
                <div class="thumb">
                  <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/c4.jpg" alt="">
                </div>
                <span class="course-status">Course Available</span>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="single-course">
                <div class="thumb">
                  <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/c5.jpg" alt="">
                </div>
                <span class="course-status">Course Available</span>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="single-course">
                <div class="thumb">
                  <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/c6.jpg" alt="">
                </div>
                <span class="course-status">Course Available</span>
        ...
        <div class="container-fluid">
          <div class="row justify-content-center align-items-center">
            <div class="col-lg-3 feat-img no-padding">
              <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/f1.jpg" alt="">
            </div>
            ...
            <div class="col-lg-3 feat-img no-padding">
              <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/f2.jpg" alt="">             
            </div>
            <div class="col-lg-3 no-padding feat-txt">
              <h6 class="text-uppercase text-white">Basic & Common Repairs</h6>
              <h1>Basic Revolutions</h1>
        ...
        <div class="container">
          ...
          <div class="row justify-content-center d-flex align-items-center">
            <div class="col-md-3 single-team">
                <div class="thumb">
                    <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/t1.jpg" alt="">
            ...
            <div class="col-md-3 single-team">
                <div class="thumb">
                    <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/t2.jpg" alt="">
                    <div class="align-items-center justify-content-center d-flex">
                  <a href="#"><i class="fa fa-facebook"></i></a>
                  <a href="#"><i class="fa fa-twitter"></i></a>
                  <a href="#"><i class="fa fa-linkedin"></i></a>
            ...
            <div class="col-md-3 single-team">
                <div class="thumb">
                    <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/t3.jpg" alt="">
                    <div class="align-items-center justify-content-center d-flex">
                  <a href="#"><i class="fa fa-facebook"></i></a>
                  <a href="#"><i class="fa fa-twitter"></i></a>
                  <a href="#"><i class="fa fa-linkedin"></i></a>
            ...
            <div class="col-md-3 single-team">
                <div class="thumb">
                    <img class="img-fluid" src="<?php echo base_url().'resources/front/' ?>img/t4.jpg" alt="">
                    <div class="align-items-center justify-content-center d-flex">
                  <a href="#"><i class="fa fa-facebook"></i></a>
                  <a href="#"><i class="fa fa-twitter"></i></a>
                  <a href="#"><i class="fa fa-linkedin"></i></a>
        ...
        <div class="container">
          <div class="row logo-wrap">
              <a class="col single-img" href="#">
                <img class="d-block mx-auto" src="<?php echo base_url().'resources/front/' ?>img/l1.png" alt="">
              </a>
              <a class="col single-img" href="#">
                <img class="d-block mx-auto" src="<?php echo base_url().'resources/front/' ?>img/l2.png" alt="">
              </a>
              <a class="col single-img" href="#">
                <img class="d-block mx-auto" src="<?php echo base_url().'resources/front/' ?>img/l3.png" alt="">
              </a>
              <a class="col single-img" href="#">
                <img class="d-block mx-auto" src="<?php echo base_url().'resources/front/' ?>img/l4.png" alt="">
              </a>
              <a class="col single-img" href="#">
                <img class="d-block mx-auto" src="<?php echo base_url().'resources/front/' ?>img/l5.png" alt="">
              </a>
          </div>  
        </div>  
      </section>
